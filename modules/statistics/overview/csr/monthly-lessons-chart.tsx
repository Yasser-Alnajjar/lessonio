...
interface MonthlyLessonsChartProps {
  data: ChartPoint[];
}

export function MonthlyLessonsChart({ data }: MonthlyLessonsChartProps) {
  const t = useTranslate("statistics.charts.monthlyLessons");
      ...
      <div style={{ height: 220 }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 8, right: 8, left: -20, bottom: 0 }}>
            ...
            />
            <Bar dataKey="value" radius={[4, 4, 0, 0]} style={{ fill: "var(--chart-2)" }} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </ChartCard>
